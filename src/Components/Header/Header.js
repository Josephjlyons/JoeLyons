    ...
    return (
        <div className='header'>
            <ul id="nav" className="header__nav">
                ...
                <li><a className="header__nav--item" href='https://docs.google.com/document/d/14y2lHTV8S7WNrUancx8AV5NL0C6BFgX0oCL4gwMoIgk/export?format=pdf' aria-label='resume'>Resume</a></li>
            </ul>
