...
const Portfolio = () => {
    return (
        ...
        <div id='portfolio' className='portfolio'>
                ...
                <figure className='portfolio__item portfolio__item--1'><p className='portfolio__header--yelp'>YelpCamp</p>
                <img src={yelpCamp} alt='yelpcamp homepage' className='worksImg' />
                </figure>

                <figure className='portfolio__item portfolio__item--2'>  <p className='portfolio__header--draught'>Draught Picker</p>
                <img src={draughtPicker} alt='draught homepage' className='worksImg' />
                </figure>

                <figure className='portfolio__item portfolio__item--3'><p className='portfolio__header--dnd'>DnD Creator</p>
